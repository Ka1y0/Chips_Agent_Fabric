...
Provider CLIs are not installed, updated, authenticated, or reconfigured by Supervisor. A
...
| Cyber Office | Same REST/WebSocket read contract | Live real-task REST/WebSocket integration passed; 118 unit + 5 UI tests passed | Defaults to mock; remote mode is explicit and fail-closed |
